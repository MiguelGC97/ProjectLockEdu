...
module.exports = {
  async up(queryInterface) {
    await queryInterface.bulkInsert('items', [
      ...
      { id: 21, typeId: 1, boxId: 11, description: 'Portátil Asus de casilla 2', state: 'returned', createdAt: new Date(), updatedAt: new Date() },
      { id: 22, typeId: 1, boxId: 11, description: 'Portátil Msi de casilla 2', state: 'returned', createdAt: new Date(), updatedAt: new Date() },
      { id: 23, typeId: 1, boxId: 11, description: 'Portátil Acer de casilla 2', state: 'returned', createdAt: new Date(), updatedAt: new Date() },
      { id: 24, typeId: 2, boxId: 11, description: 'Ratón de casilla 2', state: 'returned', createdAt: new Date(), updatedAt: new Date() },
      { id: 25, typeId: 2, boxId: 11, description: 'Teclado de casilla 2', state: 'returned', createdAt: new Date(), updatedAt: new Date() },
      { id: 26, typeId: 3, boxId: 11, description: 'Cable de casilla 2', state: 'returned', createdAt: new Date(), updatedAt: new Date() },
      { id: 27, typeId: 3, boxId: 11, description: 'Cable de casilla 2', state: 'returned', createdAt: new Date(), updatedAt: new Date() },
      { id: 28, typeId: 3, boxId: 11, description: 'Cable de casilla 2', state: 'returned', createdAt: new Date(), updatedAt: new Date() },
      { id: 29, typeId: 4, boxId: 11, description: 'Crimpadora de casilla 2', state: 'returned', createdAt: new Date(), updatedAt: new Date() },
      { id: 30, typeId: 4, boxId: 11, description: 'Tijera de casilla 2', state: 'retrieved', createdAt: new Date(), updatedAt: new Date() },
    ], {});
  },
