module.exports = {
  async up(queryInterface) {
    await queryInterface.bulkInsert('bookings', [
      { id: 1, description: 'Reserva 1', checkOut: "2024-12-10 14:00:00", checkIn: "2025-2-20 19:00:00", state: "pending", userId: 1, createdAt: new Date(), updatedAt: new Date() },
      { id: 2, description: 'Reserva 2', checkOut: "2025-2-6 19:00:00", checkIn: "2025-2-20 19:00:00", state: "returned", userId: 2, createdAt: new Date(), updatedAt: new Date() },
      { id: 3, description: 'Reserva 3', checkOut: "2024-12-10 14:00:00", checkIn: "2025-2-20 19:00:00", state: "withdrawn", userId: 2, createdAt: new Date(), updatedAt: new Date() },
      { id: 4, description: 'Reserva 4', checkOut: "2024-12-10 14:00:00", checkIn: "2025-2-20 19:00:00", state: "pending", userId: 3, createdAt: new Date(), updatedAt: new Date() },
    ], {});
