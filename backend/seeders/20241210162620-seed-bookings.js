module.exports = {
  async up(queryInterface) {
    await queryInterface.bulkInsert('bookings', [
      { id: 1, description: 'Reserva 1', checkOut: "2024-12-10T14:00:00Z", checkIn: "2024-12-15T12:00:00Z", state: "pending", createdAt: new Date(), updatedAt: new Date() },
      { id: 2, description: 'Reserva 2', checkOut: "2024-12-10T14:00:00Z", checkIn: "2024-12-15T12:00:00Z", state: "pending", createdAt: new Date(), updatedAt: new Date() },
      { id: 3, description: 'Reserva 3', checkOut: "2024-12-10T14:00:00Z", checkIn: "2024-12-15T12:00:00Z", state: "pending", createdAt: new Date(), updatedAt: new Date() },
      { id: 4, description: 'Reserva 4', checkOut: "2024-12-10T14:00:00Z", checkIn: "2024-12-15T12:00:00Z", state: "pending", createdAt: new Date(), updatedAt: new Date() },
    ], {});
